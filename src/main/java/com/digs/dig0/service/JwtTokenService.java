...
import static com.digs.dig0.utils.Constants.REFRESH_TOKEN_TYPE;
import static com.digs.dig0.utils.Constants.ROLES;
...
public class JwtTokenService {
    ...
    public String createToken(String type, String username, Collection<GrantedAuthority> roleNames, long validityInMillis) {
        Date now = new Date();
